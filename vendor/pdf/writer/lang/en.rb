...
#
# $Id: en.rb,v 1.10 2005/07/15 20:42:37 austin Exp $
#++
...
code. Please change it.
    ...
    :page_numbering_deprecated      => "%1s has been deprecated. Consider using PDF::PageNumbers instead.",
